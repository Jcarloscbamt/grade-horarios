...
<div>
    ...
    <div class="alert alert-warning d-flex justify-content-between align-items-center py-2 px-3 mb-3 border-warning">
        <div>
            ...
            @if(count($selecionados) < $totalGrupos)
            — <button wire:click="selecionarTodas" class="btn btn-sm btn-link p-0 align-baseline">
                Selecionar todas as {{ $totalGrupos }} (todas as páginas)
              </button>
            @endif
        </div>
