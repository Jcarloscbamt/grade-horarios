...
<div>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <small class="text-muted">Gerenciamento de disciplinas por curso</small>
        </div>
        @hasrole('admin')
    ...
    <div class="card mb-3 border-0 shadow-sm">
        <div class="card-body py-2">
            <div class="input-group">
                ...
                <input type="text" wire:model.live.debounce.300ms="search" class="form-control border-start-0" placeholder="Pesquisar por nome da disciplina ou curso...">
            </div>
        </div>
    </div>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-primary bg-opacity-10 text-primary">{{ $disciplina->curso->sigla }}</span></td>
                        <td>{{ $disciplina->semestre_grade }}º semestre</td>
                    ...
                    @empty
                    <tr><td colspan="5" class="text-center text-muted py-5"><i class="bi bi-inbox fs-3 d-block mb-2"></i>Nenhuma disciplina encontrada.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" wire:model="nome" class="form-control @error('nome') is-invalid @enderror" placeholder="Ex: Gestão de Projetos de Sistemas">
                            @error('nome') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-medium">Semestre da Grade <span class="text-danger">*</span></label>
                            <input type="number" wire:model="semestre_grade" class="form-control @error('semestre_grade') is-invalid @enderror" placeholder="Ex: 6" min="1" max="10">
