...
<head>
    ...
    {{-- Impede o Chrome de buscar recursos externos --}}
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        table { width: 100%; border-collapse: separate; border-spacing: 4px; font-size: 12px; }
        ...
        tbody td { vertical-align: middle; text-align: center; padding: 0; }
    ...
    <script>
        // Dispara impressão assim que a página carregar completamente
...
@if($periodo->avaliacao1_inicio || $periodo->avaliacao2_inicio)
<div class="info-bar">
    <strong>INFORMAÇÕES</strong>
    @if($periodo->avaliacao1_inicio)
    <span>&#9632; <strong>Avaliação 1:</strong> {{ $periodo->avaliacao1_inicio->format('d/m') }} a {{ $periodo->avaliacao1_fim?->format('d/m/Y') }}</span>
    @endif
    @if($periodo->avaliacao2_inicio)
    <span>&#9632; <strong>Avaliação 2:</strong> {{ $periodo->avaliacao2_inicio->format('d/m') }} a {{ $periodo->avaliacao2_fim?->format('d/m/Y') }}</span>
    @endif
    ...
    <span class="contato">
        ...
        &nbsp;|&nbsp;
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="white" style="vertical-align:middle;margin-right:3px">
